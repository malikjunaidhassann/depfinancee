...
function Header() {
  ...
  return (
    <header className="w-full sticky top-0 z-30 bg-white font-sans shadow-sm">
      <div className="flex justify-evenly items-center w-[95%] mx-auto md:w-full py-2">
        {/* Logo */}
        <Link
          href="/"
          className="relative w-[250px] h-[110px] cursor-pointer -ml-6 md:ml-0"
        >
          <Image
            src={Logo}
            width={250}
        ...
        <nav className="hidden md:flex" aria-label="Main navigation">
          <ul className="flex gap-8">
            <li>
              <Link
                href="/"
                className="text-gray-900 text-[15px] hover:text-teal-500 transition"
              >
                Home
              </Link>
            </li>
        ...
        <div className="flex items-center gap-6">
          ...
          <Link
            href="tel:0875107793"
            className="flex items-center gap-1 text-gray-900 hover:text-teal-500 transition"
            aria-label="Call us at 0875107793"
          >
            <Phone size={20} />
            <span className="hidden md:inline">0875107793</span>
          </Link>
          ...
          <div className="hidden md:inline">
            {user ? (
              ...
              <button
                className="px-6 py-2 rounded-lg bg-gray-100 text-teal-500 font-semibold text-sm hover:bg-gray-200 transition"
                onClick={() => router.push("/login")}
                aria-label="Navigate to login page"
                type="button"
              >
